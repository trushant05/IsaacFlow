...
class ContainerInterface:
    ...
    def __init__(
        ...
        self.container_name = f"isaac-sim-{self.profile}{self.suffix}"
        self.image_name = f"isaac-sim-{self.profile}{self.suffix}:latest"
    ...
    def start(self):
        ...
        container_history_file = self.context_dir / ".isaac-sim-docker-history"
    ...
    #         docker_isaac_sim_path = Path(self.dot_vars["DOCKER_WORKDIR"])
    #         artifacts = {
    ...
    #                     "docker",
    #                     "cp",
    #                     f"isaac-sim-{self.profile}{self.suffix}:{container_path}/",
    #                     f"{host_path}",
    #                 ],
    #                 check=False,
    #             )
